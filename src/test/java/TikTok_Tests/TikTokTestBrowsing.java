...
public class TikTokTestBrowsing extends BaseTest2 {
...
//       Thread.sleep(1500);
        ...
        //open users videos
        tikTokHelper.openRandomVideo();
        //swipe and repost RANDOM
        tikTokHelper.swipeRepost(TikTokHelper.getRandomNumberBetween(3,5));
        Thread.sleep(3000);
